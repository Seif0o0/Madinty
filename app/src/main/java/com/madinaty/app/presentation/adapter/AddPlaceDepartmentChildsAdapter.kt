...
import com.madinaty.app.databinding.AddPlaceDepartmentChildItemBinding
import com.madinaty.app.databinding.DepartmentChildItemBinding
import com.madinaty.app.domain.model.DepartmentChild

class AddPlaceDepartmentChildsAdapter(private val clickListener: ListItemClickListener<DepartmentChild>) :
    ListAdapter<DepartmentChild, AddPlaceDepartmentChildsAdapter.ViewHolder>(DepartmentChildsComparator) {
    ...
    class ViewHolder private constructor(private val binding: AddPlaceDepartmentChildItemBinding) :
        ...
        companion object {
            fun from(parent: ViewGroup): ViewHolder {
                return ViewHolder(
                    AddPlaceDepartmentChildItemBinding.inflate(
