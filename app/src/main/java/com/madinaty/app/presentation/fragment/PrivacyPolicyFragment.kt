...
import com.madinaty.app.databinding.FragmentPrivacyPolicyBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launchWhenStarted {
            viewModel.commonInfo.collectLatest {
                binding.privacyPolicyString = if (it == null) {
                    ""
                } else {
                    it.privacyPolicy.ifEmpty { getString(R.string.empty_list_text) }
                }
            }
        }
    }
